    ...
    public Location getLocation() {
        ...
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                Log.d("gps","!isGPSEnabled && !isNetworkEnabled is True");
            } else {
                ...
                if (hasFineLocationPermission == PackageManager.PERMISSION_GRANTED && hasCoarseLocationPermission == PackageManager.PERMISSION_GRANTED) {
                    Log.d("gps","hasFineLocationPermission == PackageManager.PERMISSION_GRANTED && hasCoarseLocationPermission == PackageManager.PERMISSION_GRANTED is True");
                } else {
                    return null;
                }
                if (isNetworkEnabled) {
